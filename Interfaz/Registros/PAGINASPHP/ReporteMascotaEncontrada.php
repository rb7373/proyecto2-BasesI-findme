...
<div class="wrapper">
  <form class="form" method="post" action="ProcedimientosPHP/ingresoMascotaEncontrada.php">
    <fieldset>
      ...
      <fieldset>
        ...
        <div>
          <input type="date" id = "fechaPerdida"class="fechaPerdida" name ="fechaEncontrada" placeholder="Fecha de la pérdida"required >
        </div>
        <br>
